  ...
  return (
    <div className="min-h-screen bg-light-200 flex flex-col w-full max-w-[1100px] mx-auto relative overflow-hidden">
      ...
      <div className="flex items-center px-6 py-4 bg-white border-b border-gray-200">
        ...
        <h1 className="text-lg font-semibold text-gray-900">Seminar Synopsis Submission</h1>
      </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-xl font-semibold text-gray-900 mb-2">Submit Your Seminar Synopsis</h2>
        <p className="text-gray-600 text-sm leading-relaxed">
          Upload your complete seminar Synopsis for the De Victorium Class of 2025
        </p>
      </motion.div>
      ...
      >
        ...
        <motion.div variants={itemVariants}>
          <UploadCard
            ...
            description="Click to upload your complete seminar Synopsis document (DOC preferred)"
            icon={FileText}
            file={uploadedFile}
    ...
    >
      ...
      >
        ...
        <motion.p 
          ...
          variants={itemVariants}
        >
          Your seminar Synopsis for the De Victorium Class of 2025 has been successfully submitted. 
...
const Synopsis = CardTransition(SeminarSynopsis);
