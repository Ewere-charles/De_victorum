...
import { ArrowLeft, Plus, FileText, Clock, Check, Eye, Presentation } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-light-200 flex flex-col w-full max-w-[1100px] mx-auto relative overflow-hidden">
      ...
      <div className="flex items-center px-6 py-4 bg-white border-b border-gray-200">
        ...
        <h1 className="text-lg font-semibold text-gray-900">Seminar Slides Submission</h1>
      </div>
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex justify-center mb-6">
          <div className="relative">
            <div className="w-24 h-32 bg-light-200 rounded-lg border-2 border-dashed border-gray-300 flex flex-col items-center justify-center">
              <Presentation className="w-8 h-8 text-gray-400 mb-2" />
              <div className="w-6 h-1 bg-red-600 rounded mb-1"></div>
        ...
        <h2 className="text-xl font-semibold text-gray-900 mb-2">Submit Your Seminar Slides</h2>
        <p className="text-gray-600 text-sm leading-relaxed">
          Upload your complete seminar presentation slides for the De Victorium Class of 2025
        </p>
      </motion.div>
      ...
      >
        ...
        <motion.div variants={itemVariants}>
          <UploadCard
            ...
            description="Click to upload your seminar presentation (PPT/PPTX format)"
            icon={Presentation}
            file={uploadedFile}
      ...
      {/* Submit Button */}
      <motion.div 
        className="fixed bottom-0 left-0 right-0 w-full max-w-[1100px] mx-auto p-6 bg-white border-t border-gray-200"
        variants={itemVariants}
      >
        <motion.button
          onClick={onSubmit}
          ...
          <div className="flex-1 min-w-0">
            ...
            {file ? (
              <div className="text-sm text-gray-600 min-w-0">
                <p className="font-medium text-red-600 truncate">{file.name}</p>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="relative">
            ...
            <motion.div 
              className="absolute bottom-4 right-4 w-12 h-12 bg-red-800 rounded-full flex items-center justify-center"
              variants={itemVariants}
            ...
            >
              <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center">
                <div className="w-1 h-3 bg-red-800 rounded"></div>
                <div className="w-3 h-1 bg-red-800 rounded ml-0.5"></div>
              </div>
            </motion.div>
          </div>
        </motion.div>
        ...
        <motion.p 
          ...
          variants={itemVariants}
        >
          Your seminar slides for the De Victorium Class of 2025 has been successfully submitted. 
      ...
      >
        <motion.button
          onClick={onExit}
          className="w-full py-4 bg-red-600 text-white rounded-xl font-semibold hover:bg-red-700 active:scale-95 transition-all duration-300"
          whileTap={{ scale: 0.95 }}
        >
          Return to Dashboard
        </motion.button>
...
const DocumentPreviewCard = ({ title, file, formatFileSize }) => {
  ...
  return (
    <>
      <motion.div 
        className="p-4 bg-white border border-red-200 rounded-xl shadow-sm"
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm font-medium text-red-600 mb-1 truncate">{file.name}</p>
...
const synopsis = CardTransition(SeminarSlide);
